...
CUnbreakableBlock::CUnbreakableBlock(int idx) :CPlatform()
{
	...
	if(idx == 4) // 4, 6~11
		...
		imagePos = { Vec2(188, 119), Vec2(16, 16), Vec2(0, 0), 0 };
	else if (idx == 7)
		imagePos = { Vec2(204, 119), Vec2(16, 16), Vec2(0, 0), 0 };
	else if (idx == 8)
		imagePos = { Vec2(170, 119), Vec2(16, 16), Vec2(0, 0), 0 };
	else if (idx == 9)
		imagePos = { Vec2(188, 136), Vec2(16, 16), Vec2(0, 0), 0 };
	else if (idx == 10)
		imagePos = { Vec2(204, 136), Vec2(16, 16), Vec2(0, 0), 0 };
	else if (idx == 11)
		imagePos = { Vec2(170, 136), Vec2(16, 16), Vec2(0, 0), 0 };
}
